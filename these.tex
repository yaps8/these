...
\usepackage{titlesec}
\usepackage{url}
\usepackage[backend=biber, language=french, citestyle=alphabetic,bibstyle=alphabetic,backref,abbreviate=false,dateabbrev=false,isbn=false,url=false,doi=true]{biblatex}
...
\ThesisTitle{Analyse morphologique pour la détection de malwares auto-modifiants}
