...
\newpage
  \begin{FrenchAbstract}
    \input{resume}
    \KeyWords{programmes malveillants, auto-modification, analyse dynamique, analyse statique, graphe de flot de contrôle, comparaison de graphes, détection}
  \end{FrenchAbstract}
  \begin{EnglishAbstract}
    \input{abstract}
    \KeyWords{malwares, self-modification, dynamic analysis, static analysis, control flow graph, graph comparison, detection}
  \end{EnglishAbstract}
\end{ThesisAbstract}
\end{document}
