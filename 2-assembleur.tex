...
De nombreuses techniques de protection sont applicables à un programme binaire pour rendre son analyse plus compliquée. Certaines ont pour but de rendre le code plus difficile à comprendre en ajoutant par exemple du code inutile. Au contraire une technique consiste à modifier le programme au cours de son exécution afin que le code réellement utile du binaire ne soit pas lisible à première vue.
...
Nous décrirons dans la partie suivante plusieurs techniques d'obscurcissement statiques ainsi que l'auto-modification.
