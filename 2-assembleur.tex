...
Pourtant l'instruction \texttt{mov [eax],0x7eb} à l'adresse $0x8048086$ remplace saut initial par un saut vers l'adresse $0x8048095$ où la valeur de \edi\ sera fixée à 2 avant l'affichage de celle-ci.
...
On a vu que la taille d'une instruction assembleur varie de un à 16 octets \todo{15 ou 16?}.
