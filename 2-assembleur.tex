...
Un désassemblage suivant un parcours linéaire désassemble, pour chaque section, la première instruction à l'adresse $a$ puis l'instruction à l'adresse $a+k$ où k est la nombre d'octets sur lesquels l'instruction est codée.
...
Pour pallier à l'incomplétude d'un parcours récursif, des chercheurs \todo{cite} ont proposé un parcours spéculatif pour les parties de mémoire non désassemblées par l'approche récursive.
