...
\subfigure[GFC par analyse statique et récursive]{
...
\itodo{GFC avec octets, CFA automates de Jakstab / Kinder}
(\todo{nom+cite}) proposent d'introduire la représentation sous forme d'octets de chaque instruction au sein du GFC et d'ajouter les conditions des sauts conditionnels légende des arcs du GFC. (...)
