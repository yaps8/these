...
Reprenons l'exemple de \telock. L'extrait de \telock\ donné à la figure \ref{fig:telock_obf_disas} et dont le graphe de flot est donné en figure \ref{fig:telock_cfg} peut se voir comme composé des deux \layers\ de code données à la figure \ref{fig:telock-layers-recursive}.
...
\hline
\Layer\ 1 & \multicolumn{2}{c|}{jmp +1} & \cellcolor[gray]{0.0} & \multicolumn{2}{c|}{jg 0x1006e68}\\
\hline
\Layer\ 2 & \cellcolor[gray]{0.0} & \multicolumn{2}{c|}{dec ecx} & \multicolumn{2}{c|}{\cellcolor[gray]{0.0}} \\
 \hline
% \\
\end{tabular}
\end{center}
...
L'exemple précédent pour \telock\ donne un exemple de découpage d'un désassemblage en \layers.
...
\itodo{alignement et réalignement}
...
\hline
\Layer\ 2 & \cellcolor[gray]{0.0} & \multicolumn{2}{c|}{dec ecx} & \multicolumn{2}{c|}{jg 0x1006e68} \\
 \hline
% \\
\end{tabular}
\end{center}
...
\hline
Layer 2 @0xfb & \multicolumn{5}{c|}{\cellcolor[gray]{0.0}} & push edi & dec eax & \multicolumn{2}{c|}{repne scasb} & push ebp\\
\hline
% \\
\end{tabular}
\end{center}
