...
Considérons un programme et son graphe de flot de contrôle parfait \todo{def}.
...
D'autre part on peut compter le nombre de sauts d'une instruction d'une \layer\ vers une instruction désalignée d'une autre \layer. Dans le cas de \telock, le saut depuis l'instruction \texttt{dec ecx} à l'adresse \adr{0x01006e7e} vers l'instruction \texttt{jg 0x1006e68} à l'adresse \adr{0x01006e80}

\paragraph{Métriques pour le chevauchement de code.}

\itodo{métrique / paramêtres intéressants ?}
