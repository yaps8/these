...
\begin{itemize}
 ...
 \item Todo : illustration interactive dans plusieurs directions
 }
\end{itemize}
\only<1>{
\begin{center}
...
Analyse dynamique puis statique
\begin{itemize}
 \item Utilisation d'une trace
 \item Construction des couches de code
\end{itemize}
...
\item Définition d'un graphe de flot de contrôle pour programmes auto-modifiants et analyse hybride
