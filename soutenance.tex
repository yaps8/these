...
\begin{frame}[t]{Détection et désassemblage}
Objectif : détection de logiciels malveillants (programmes binaires)

\pause
\vskip2ex
Analyse morphologique (Kaczmarek) :
\begin{itemize}
...
Trace 2 & $s_1$ & $s_2$ & $s_7$ & $s_5$ & $s_6$ & Instantanés de la mémoire\\
...
\begin{itemize}
 ...
 \begin{itemize}
  \item de 2 à 4 couches lors du désassemblage
  \item de nombreux sauts entre couches (jusqu'à 1817 pour jdpack)
 \end{itemize}
\vskip2ex
...
\end{itemize}
\vskip3ex
But : définir un sous-problème $\rightarrow$ solutions en temps polynomial ?
\end{frame}
...
\end{center}
\only<2>{\vskip-1.5ex Découpage : $<$ 1 seconde}
% \caption{}
% \label{fig:scan}
% \end{figure}
\end{frame}
