...
\paragraph{Langage assembleur simplifié.} Le langage assembleur est très simple du point de vue de la sémantique. Il peut être modélisé comme contenant des instructions disponibles à différentes adresses entières. 
...
\todo[inline]{adresse -> liste d'instructions}
\todo[inline]{comment exécuter un programme asm avec un langage intermédiaire}
Une instruction assembleur va donc être traduite en plusieurs instructions dans le langage intermédiaire
