...
Pour une instruction $I$ on note l'intervalle d'adresses mémoire sur lesquelles elle est codée \dc{I}.
...
\begin{defi}
 Une \layer\ de code $L$ est un ensemble d'instructions dynamiques qui ne se chevauchent pas : $\forall D_1, D_2\in L,\ $\dc{I_1}$\cap$\dc{I_2}$=\emptyset$.
\label{def:layer}
\end{defi}
