...
Une définition formelle du désassemblage parfait d'un programme P (définition \ref{def:desassemblage_parfait}) est alors la détermination de l'ensemble des adresses atteignables de P.
