...
La première implémentation de l'architecture de Harvard était L’ASCC (\emph{Automatic Sequence Controlled Calculator}) d'IBM, également appelé le Mark I, et considérée comme le premier calculateur universel, en 1944. 
