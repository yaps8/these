...
\begin{defi}
 Étant donné un programme \nsm\ P prenant une entrée I, le graphe de flot de contrôle parfait de P est le graphe orienté $G=(V, E)$ tel que :
 \begin{itemize}
  \item V est l'ensemble des sommets de G et est inclus dans l'ensemble des adresses de P
  \item $E\subset V\times V$ est l'ensemble des arcs de G
