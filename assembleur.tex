% \newcommand{\xqq}{x862}
\igdo{Mieux délimiter les figures}
...
La mémoire physique de la machine peut-être faite de supports volatiles (mémoire vive), de supports amovibles (disques durs), ou autre.
...
\imore{informel -> un exemple de liste des chemins d'exec}
\itodo{sur et sous approximation}
