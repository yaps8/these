...
Une des principales difficultés réside dans l'utilisation de sauts dynamiques de type \texttt{jmp eax} dont la cible ne peut être déterminée qu'en ayant une connaissance fine de la ou des valeurs possibles pour \eax.
...
\begin{defi}
 Étant donné un programme P prenant une entrée I, le désassemblage parfait de P est la donnée de l'ensemble des adresses $a$ de P pouvant être atteintes, soit $\bigcup_{I} \{a,\ P(I)\ atteint\ a\}$.
