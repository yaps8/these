...
La donnée centrale reste l'ensemble des exécutions possibles du programme, quelle que soit l'entrée choisie.
...
Le problème de cette définition d'un CFG pour un programme \sm\ est que souvent les vagues se suivent et ont peu de rapport les unes avec les autres. Prenons un programme dont l'action est d'une part de déchiffrer un bloc de la mémoire dans lequel se trouve la charge finale puis d'exécuter ce bloc déchiffré.
Nous considérons qu'il est plus sensé d'analyser ces deux parties de manières indépendante plutôt que de les mélanger dans le même graphe de flot de contrôle.
...
\hline
 8048060 <debut>  &  40                 &  inc    eax \\
 8048061  &  74 07                      &  jz     804806a <si\_zero> \\
 	  &				&					\\
 8048063  &  bf 02 00 00 00             &  mov    edi, 2 \\
 8048068  &  eb f6                      &  jmp    8048060 <debut> \\
	  &				&					\\
 804806a <si\_zero>  &  bf 01 00 00 00  &  mov    edi, 1 \\
 804806f  &  bb 60 80 04 08             &  mov    ebx,0x8048060 <debut> \\
 8048074  &  66 c7 43 01 c9 00          &  mov    [ebx], 90 \\
 8048079  &  66 c7 43 01 c9 00          &  mov    [ebx+1], c3 \\
 804807f  &  eb e4                      &  jmp    8048060 <debut> \\
\hline
\end{tabular}
\label{fig:sm_asm}
}
...
\begin{figure}
\begin{center}
\subfigure[CFG parfait]{
\includegraphics[width=0.45\textwidth]{supports/disas_sm/ex2_parfait.pdf}
% \input{supports/eax-cfg/eax.tex}
\label{fig:sm_cfg_parfait}
}
\subfigure[CFG paramétré par une exécution]{
\includegraphics[width=0.5\textwidth]{supports/disas_sm/ex2_vagues.pdf}
% \input{supports/eax-cfg/eax.tex}
