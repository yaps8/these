...
% v et x
\newcommand{\checkv}{\ding{51}}
\newcommand{\checkf}{\ding{55}}
...
% Adresses mémoire :
\newcommand{\adr}[1]{\texttt{0x#1}}
\newcommand{\adra}[1]{\texttt{#1}}
% newtxtt
% \newcommand{\adr}[1]{{\fontfamily{cmtt}\selectfont 0x#1}}
% \newcommand{\adr}[1]{\asciifamily 0x#1}
% Registres
...
% hostname
\newcommand{\hostname}{\texttt{hostname.exe}}
...
\newcommand{\Crysys}{CrySys}
\newcommand{\duqu}{Duqu}
\newcommand{\stux}{Stuxnet}
...
\newcommand{\ZwAp}{\path{ZwAllocateVirtualMemory}}
\newcommand{\ZwPp}{\path{ZwProtectVirtualMemory}}
\newcommand{\ZwA}{\emph{ZwAllocateVirtualMemory}}
\newcommand{\ZwP}{\emph{ZwProtectVirtualMemory}}
